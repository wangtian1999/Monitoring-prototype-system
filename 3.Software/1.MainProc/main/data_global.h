...
unsigned char led_cmb[QUEUE_MSG_LEN]; 	//灯控制命令
unsigned char buzzer_cmb[QUEUE_MSG_LEN]; 	//蜂鸣器控制命令
unsigned char fan_cmb[QUEUE_MSG_LEN];  //风扇控制命令
...
extern void *pthread_fan(void *arg);                 //fan风扇控制线程
extern void *pthread_rfid(void *arg);
