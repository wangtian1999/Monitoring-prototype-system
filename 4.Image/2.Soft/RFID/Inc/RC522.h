...
void CardData_screen_LCD_show(void);
void ScreenShowID(uint8_t id);
...
void RFID_Write_Value(uint8_t addr, uint8_t mode, unsigned char *val);
...
extern unsigned char cmd_dat[16];
extern unsigned char cmd_type;
extern unsigned char cmd_addr;
extern unsigned char cmd_check;
extern unsigned char KEY_A[6];
extern unsigned char KEY_B[6];
